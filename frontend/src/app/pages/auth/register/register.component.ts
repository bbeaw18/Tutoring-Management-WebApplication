...
export class RegisterComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  private runHeroTimeline(): void {
    ...
    this.heroTl
      ...
      .to(eqParts, { opacity: 1, y: 0, duration: 0.5, stagger: 0.06, ease: 'power2.out' }, '-=0.35')
    ...
    if (orbit) {
      ...
      gsap.to(orbit, { rotate: 360, duration: 24, ease: 'none', repeat: -1, transformOrigin: '60px 0px' });
    }
  }
